...
```{r ALL_TS4, echo=FALSE, eval=FALSE, cache=FALSE}
...
```{r ALL_TS4_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
all_ts4_vars<-unique(unlist(all_ts4[1:100]))
all_ts4_rf<-runRandomForest(hkm2014Data[all_ts4_vars],TS_CHLA_4, ntree=10000,importance=TRUE,proximity=TRUE)
```
...
```{r ALL_TS3, echo=FALSE, eval=FALSE, cache=FALSE}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
...
```{r all_TS3_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
all_ts3_vars<-unique(unlist(all_ts3[1:100]))
all_ts3_rf<-runRandomForest(hkm2014Data[all_ts3_vars],TS_CHLA_3, ntree=10000,importance=TRUE,proximity=TRUE)
```
...
```{r ALL_TS2, echo=FALSE, eval=FALSE, cache=FALSE}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
...
```{r all_TS2_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
all_ts2_vars<-unique(unlist(all_ts2[1:100]))
all_ts2_rf<-runRandomForest(hkm2014Data[all_ts2_vars],TS_CHLA_2, ntree=10000,importance=TRUE,proximity=TRUE)
```
...
```{r GIS_TS4, echo=FALSE, eval=FALSE, cache=FALSE}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
...
```{r GIS_TS4_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
gis_ts4_vars<-unique(unlist(gis_ts4[1:100]))
gis_ts4_rf<-runRandomForest(hkm2014Data[gis_ts4_vars],TS_CHLA_4, ntree=10000,importance=TRUE,proximity=TRUE)
```
...
```{r GIS_TS3, echo=FALSE, eval=FALSE, cache=FALSE}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
...
```{r GIS_TS3_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
gis_ts3_vars<-unique(unlist(gis_ts3[1:100]))
gis_ts3_rf<-runRandomForest(hkm2014Data[gis_ts3_vars],TS_CHLA_3, ntree=10000,importance=TRUE,proximity=TRUE)
```
...
```{r GIS_TS2, echo=FALSE, eval=FALSE, cache=FALSE}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
...
```{r GIS_TS2_rf,echo=FALSE,eval=F,cache=F}
#Included for completeness.  Results already run in another project
#Those results loaded via lazyLoad in setup chunk
gis_ts2_vars<-unique(unlist(gis_ts2[1:100]))
gis_ts2_rf<-runRandomForest(hkm2014Data[gis_ts2_vars],TS_CHLA_2, ntree=10000,importance=TRUE,proximity=TRUE)
```
